...
/* Generated from ../O.Common/PfeifferEDU.dbd */
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"PfeifferEDU_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    PfeifferEDU_registerRecordDeviceDriver(*iocshPpdbbase);
}
